...
<body>
	...
	<div class="owl-carousel owl-theme main_banner">
        <div class="item"><img height="600px" src="img/hotellist.jpg" alt="" /></div>
    </div>
	<!--/hero_in-->
 ...
 if(isset($_GET['search']))
{
	...
	$_SESSION['dates']=$ip;
	$iparr = explode(">", $ip); 
$_SESSION['checkin']=$iparr[0];
$_SESSION['checkout']=$iparr[1];
$_SESSION['adult']=$_GET['qtyInputA'];
$_SESSION['child']=$_GET['qtyInputC'];
}
        ...
        <div class="container">
            <form action="hotel_list.php" method="get" enctype="multipart/form-data">
                <div class="row no-gutters custom-search-input-2" >
                    ...
                    <div class="col-lg-2">
                        <input type="submit" class="btn_search btn btn-danger wrn-btn ripple" value="Search" name="search">
                    </div>
                </div>
            </form>
        </div>
...
?>
 ...
 <br>
 <br>
 <div class="container container-custom margin_80_0 py-4">
...
{
$city=$_SESSION['city'];
$q = "SELECT hotelid,hotel_name,hotel_img,description,city,address FROM hotels where isDeleted='N' and city='$city'";
	
}
else
{
	$q = "SELECT hotelid,hotel_name,hotel_img,description,city,address FROM hotels where isDeleted='N'";
				...
				<div class="col-xl-4 col-lg-6 col-md-6 isotope-item popular">
					<div class="box_grid">
						<figure>
							...
							<a href="hotel_detail.php?id=<?php echo $arr2['hotelid']; ?>">
						...
						<div class="wrapper">
							<h3><a href="hotel_detail.php?id=<?php echo $arr2['hotelid']; ?>"><?php echo $arr2['hotel_name']?></a></h3>
