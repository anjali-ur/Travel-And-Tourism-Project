...
<div class="search-sec bg-transparent d-none d-sm-block" style="top:50%;">
        <div class="container text-center tag_line">
            <h3>Contact Us</h3>
            <p>Contact information about GR Travels</p>
        </div>
    </div>
    </section>
...
<div class="col-sm-4">
<div class="well">
<h3><i class="fa fa-briefcase fa-lg" aria-hidden="true"></i></h3>
<h3>Head Office</h3>
<p>Juhu Rd, near Juhu Beach, </p><p>Airport Area, Juhu </p><p>Mumbai, Maharashtra 400049</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="well">
	  <h3><i class="fa fa-envelope-o fa-lg" aria-hidden="true"></i>
        <h3>Email</h3>
        <p>grtravels@gmail.com </p>
		<br>
		<br>
		<br>
		</div>  		
    ...
    <div class="col-sm-4">
      <div class="well">
	  <h3><i class="fa fa-phone fa-lg" aria-hidden="true"></i></h3>
        <h3>Phone</h3>        
        <p>+91 9123456780</p>
		<br>
		<br>
