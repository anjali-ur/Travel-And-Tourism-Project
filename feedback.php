...
<div class="search-sec bg-transparent d-none d-sm-block" style="top:50%;">
        <div class="container text-center tag_line">
            <h3>Feedback Form</h3>
            <p>Give your valuable suggestions for us to improve</p>
        </div>
    </div>
    </section>
	<div class="form-register">
		<div class="container">
		<form name="registration"  action="feedback.php" onsubmit="return checkForm()" method="post">
<h3><u>Feedback Form</u></h3> 
		<div class="form-group input-group">
		<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		<input type="text" id="name" name="uname" class="form-control" placeholder="Enter your Name">
		</div>
		...
		<h4>Any Suggestions</h4>
		    <div class="form-group input-group">
      <textarea class="form-control" rows="7" cols="80" id="suggestions" name="suggestions" placeholder="Please enter your suggestions"></textarea>
    </div>
